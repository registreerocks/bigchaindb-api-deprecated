...
def test_get_all_assets(mock_assets):
    mock_assets.get.return_value = get_degree_search_result()
    asset_type = "degree"
    assert(_get_all_assets(asset_type) == get_degree_search_result())
...
def test_get_university_files(mock_assets):
    ...
    university_name = "UCT"
    asset_type = 'degree'
    assert(_get_assets_by_university(university_name, asset_type) == get_degree_search_result())
